...
class Base64Decoder
{
    ...
    public:
        ...
        const std::vector<std::byte> &GetRawDecodedData() const noexcept { return m_DecodedData; }
...
class Base64Encoder
{
    ...
    public:
        ...
        const std::string &GetBase64EncodedString() const noexcept { return m_Base64EncodedString; }
