...
class Allow : public Header {
  public:
    ...
    std::vector<Http::Method> methods() const {
        return methods_;
    }
...
class Accept : public Header {
  public:
    ...
    const std::vector<Mime::MediaType> media() const {
        return mediaRange_;
    }
...
class CacheControl : public Header {
  public:
    ...
    std::vector<Http::CacheDirective> directives() const {
        return directives_;
    }
...
class Connection : public Header {
  public:
    ...
    ConnectionControl control() const {
        return control_;
    }
...
class Expect : public Header {
  public:
    ...
    Http::Expectation expectation() const {
        return expectation_;
    }
