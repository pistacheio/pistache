...
TEST(headers_test, accept)
{
...

    {
        ...
        ASSERT_EQ(mime.q().getOrElse(Pistache::Http::Mime::Q(0)), Pistache::Http::Mime::Q(20));
    }
...

    {
        ...
        ASSERT_EQ(media[0].q().getOrElse(Pistache::Http::Mime::Q(0)), Pistache::Http::Mime::Q(30));
        ...
        ASSERT_EQ(media[4].q().getOrElse(Pistache::Http::Mime::Q(0)), Pistache::Http::Mime::Q::fromFloat(0.5));
    }
