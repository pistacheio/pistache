...
RouterHandler::RouterHandler(const Rest::Router& rtr)
    : router(std::make_shared<Rest::Router>(rtr))
{ }

RouterHandler::RouterHandler(std::shared_ptr<Rest::Router> rtr)
    : router(std::move(rtr))
{ }
