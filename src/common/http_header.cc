...
void Allow::addMethod(Http::Method method) {
...
void CacheControl::write(std::ostream& os) const {
    ...
    auto hasDelta = [](CacheDirective directive) {
        return directive.directive() == CacheDirective::MaxAge || directive.directive() == CacheDirective::MaxStale ||
               directive.directive() == CacheDirective::MinFresh || directive.directive() == CacheDirective::SMaxAge;
    };
...
void ContentLength::write(std::ostream& os) const {
    os << value_;
}
...
void Authorization::write(std::ostream& os) const {
    os << value_;
}
...
void Location::parse(const std::string& data) {
    location_ = data;
}
...
void UserAgent::parse(const std::string& data) {
    ua_ = data;
}

void UserAgent::write(std::ostream& os) const {
    os << ua_;
}
...
void AccessControlAllowOrigin::parse(const std::string& data) {
    uri_ = data;
}
...
void AccessControlAllowHeaders::parse(const std::string& data) {
    val_ = data;
}
...
void AccessControlExposeHeaders::parse(const std::string& data) {
    val_ = data;
}

void AccessControlExposeHeaders::write(std::ostream& os) const {
    os << val_;
}

void AccessControlAllowMethods::parse(const std::string& data) {
    val_ = data;
}

void AccessControlAllowMethods::write(std::ostream& os) const {
    os << val_;
}
...
void Server::parse(const std::string& token) {
    tokens_.push_back(token);
}
...
void ContentType::write(std::ostream& os) const {
    os << mime_.toString();
}
